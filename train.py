from data import *
from data.coco import COCOPanoptic
...
parser = argparse.ArgumentParser(
    description='EPSNet Training Script')
...
parser.add_argument('--config_log', default='weights/cofing_log.txt', type=str,
                    help='save current config log into text file')
parser.add_argument('--log_path', default='weights/training_log.txt', type=str,
                    help='save training log into text file')
...
def compute_validation_map(epsnet, dataset):
    with torch.no_grad():
        epsnet.eval()
        print()
...
if __name__ == '__main__':
    ...
    # plt.imsave('coco_img.png', a[0][0,:,:])
    # plt.imsave('coco_gt_sem.png', a[1][2])
    # plt.imsave('cityscapes_gt_ins.png', a[1][1][0,:,:])
